-- Normalize database capability aliases by builder type.
-- Web builder advertises `database`; mobile builder advertises `supabase`.
...
begin
  ...
  v_spec := jsonb_build_object(
    ...
    'inferred',jsonb_build_object('builder_type',v_builder_type,'target',v_target,'required_capabilities',v_caps,'auth_requested',v_auth_requested,'database_requested',v_database_requested),
    'routing',v_route,

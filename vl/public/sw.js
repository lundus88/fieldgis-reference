const CACHE='vl-shell-2026-09-06.2';
const SHELL=['./','./index.html','./cinematic-home.html','./vl-cinematic-globe.js','./assisted-build.html','./prd.html','./voice.html','./build-status.html','./capabilities.html','./vl-capabilities.json','./vl-ui.css','./vl-i18n.js','./manifest.webmanifest','./vl-icon.svg','./vl-icon-maskable.svg'];

const CACHE='vl-shell-2026-09-09.1';
const SHELL=['./','./index.html','./pilot-login.html','./assisted-build.html','./prd.html','./voice.html','./build-status.html','./vl-ui.css','./vl-i18n.js','./manifest.webmanifest','./vl-icon.svg','./vl-icon-maskable.svg'];

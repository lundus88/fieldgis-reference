const CACHE='vl-shell-2026-09-01.1';
const SHELL=['/','/index.html','/assisted-build.html','/voice.html','/build-status.html','/vl-ui.css','/manifest.webmanifest','/vl-icon.svg','/vl-icon-maskable.svg'];

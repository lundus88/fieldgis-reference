const CACHE='vl-shell-2026-09-06.1';
const SHELL=['./','./index.html','./assisted-build.html','./prd.html','./voice.html','./build-status.html','./capabilities.html','./vl-capabilities.json','./vl-ui.css','./vl-i18n.js','./manifest.webmanifest','./vl-icon.svg','./vl-icon-maskable.svg'];

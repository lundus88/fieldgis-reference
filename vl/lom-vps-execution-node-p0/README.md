...
Status: MERGED CODE / NON-PRODUCTION / LIVE VPS UNVERIFIED
...
The repository implementation is merged, but it does **not** prove the real VPS is reachable, healthy or configured this way. There is no SSH/VPS connector available in the current control session. Live activation requires machine-readable evidence generated by the P1 collector on the authorized VPS.

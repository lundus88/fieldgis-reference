...
assert by_id['vl']['health']=='REVIEW'
assert by_id['ebkl']['health']=='BLOCKED'
assert by_id['sabahlot']['health']=='BLOCKED'
assert by_id['slp']['health']=='HOLD'
assert by_id['lunduslead']['health']=='BLOCKED'
assert by_id['urusmy']['health']=='BLOCKED'
assert by_id['kontenstudio']['health']=='HEALTHY'

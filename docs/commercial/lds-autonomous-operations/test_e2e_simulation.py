...
class E2ESimulationTests(unittest.TestCase):
    def test_standard_order_reaches_delivery_without_post_payment_ld_human_start(self):
        ...
        self.assertEqual(r["metrics"]["total_events"],21)
        self.assertEqual(r["metrics"]["ld_human_touchpoints"],2)
        self.assertEqual(r["metrics"]["customer_action_touchpoints"],1)
        ...
        self.assertEqual(
            r["ld_human_gate_stages"],
            ["BLUEPRINT_APPROVED_TO_QUOTATION_APPROVED","QUALIFIED_TO_BLUEPRINT_APPROVED"]
        )
        self.assertEqual(r["customer_action_stages"],["CUSTOMER_UAT_ACCEPTANCE"])
